...
namespace xna_morijobi_win.cyber_parade.scenes
{
        ...
        :scene.scene
    {
        ...
        public blanding_2(Game g) : base(g) { }
        ...
        public override void Initialize()
        {
            ...
            image = Game.Content.Load<Texture2D>(@"blanding\bland_2");
        ...
        public override void Draw(GameTime gameTime)
        {
            ...
            sprite_batch.Draw(image, new Rectangle(0, 0, GraphicsDevice.Viewport.Width, GraphicsDevice.Viewport.Height), draw_color);
            sprite_batch.End();
            base.Draw(gameTime);
        }
